    ...
    <div className="absolute bg-[#ffffff] h-[260px] left-0 right-0 top-0">
      ...
      <div className="absolute left-6 right-4 top-[103px]">
        <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-0 relative w-full">
          ...
          {/* Category Filters */}
          <div className="relative shrink-0 w-full">
            <div className="flex flex-row gap-2 overflow-x-hidden pb-2 flex-wrap">
              <button
          ...
          <div className="relative shrink-0 flex flex-row items-center justify-between w-full">
            <div className="box-border content-stretch flex flex-row gap-2 items-start justify-start p-0 relative flex-wrap">
              <button
...
function GridProductCard({ product, isFavorite, onToggleFavorite, onClick, onChatClick, onCollectibleClick }: ProductCardProps) {
    ...
    if (product.category === 'collectibles') {
      return (
        <button
          ...
          className="w-full bg-purple-600 hover:bg-purple-700 text-white py-1.5 rounded-lg transition-colors text-[10px] font-medium"
        >
          Place Bid
        </button>
      );
      ...
      return (
        <button
          ...
          className="w-full bg-[#426b1f] hover:bg-[#365a19] text-white py-1.5 rounded-lg transition-colors text-[10px] font-medium"
        >
          Contact Seller
        </button>
      );
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-shadow flex flex-col h-[260px] w-full">
      <div className="relative flex-shrink-0">
        <div
          className="w-full h-28 bg-gray-100 cursor-pointer"
          style={{
            backgroundImage: `url('${product.images[0]}')`,
            backgroundSize: 'cover',
            backgroundPosition: 'center'
        ...
        >
          ...
          <div className="absolute top-2 right-2 flex flex-col gap-1">
            ...
            <button
              ...
              className="w-6 h-6 bg-white bg-opacity-80 rounded-full hover:bg-opacity-100 transition-all flex items-center justify-center"
            >
      ...
      <div className="p-3 flex flex-col flex-1 justify-between">
        <div className="flex-1">
          ...
          <div className="flex items-center gap-1 mb-1">
            <span className="text-[#426b1f] font-medium text-sm">
              {product.category === 'collectibles' ? product.currentBid : product.price}
            </span>
            {product.category === 'collectibles' && product.bidCount && (
              <span className="text-[#757575] text-[9px]">
                ({product.bidCount} bids)
              </span>
            )}
          </div>
          ...
          <div className="flex items-center gap-1 mb-1 flex-wrap">
            <span className="text-[#757575] text-[10px] leading-tight line-clamp-1">{product.seller}</span>
            {product.condition && (
              <Badge variant="outline" className="text-[7px] px-1 py-0.5 h-fit">
                {product.condition}
              </Badge>
            )}
          </div>
          ...
          {product.emergencyFund && (
            <Badge className="bg-red-100 text-red-800 text-[7px] px-1 py-0.5 mb-1 inline-block">
              Emergency Fund
            </Badge>
          )}
